        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              Our platform combines interactive learning, real-world projects,
              and community support to help you become a professional developer.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="feature-card card group">
              ...
              <p className="text-gray-400">
                Test your knowledge with daily coding challenges and quizzes to
            ...
            <div className="feature-card card group">
              ...
              <p className="text-gray-400">
                ...
                through our recruitment platform.
              </p>
              <Link
                to="/recruitment"
            ...
            <div className="feature-card card group">
              ...
              <p className="text-gray-400">
                Participate in exciting hackathons to solve real-world problems
                and showcase your skills.
              </p>
              <Link
                to="/hackathons"
                className="inline-block mt-4 text-purple-500 hover:text-purple-400"
              >
                Join Events →
              </Link>
            </div>
            ...
            <div className="feature-card card group">
              ...
              <p className="text-gray-400">
                Join our vibrant community of developers to share knowledge, ask
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
            <div className="feature-card card group">
              ...
              <p className="text-gray-400">
                Get personalized guidance from industry experts who will help
                you navigate your coding journey.
              </p>
              <Link
                to="/mentorship"
            ...
            <div className="feature-card card group">
              ...
              <p className="text-gray-400">
                Attend live webinars and seminars on cutting-edge technologies
      ...
      <section className="py-20 bg-gray-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              Hear from developers who have transformed their careers through
              our platform.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="card relative">
              <div className="absolute -top-4 -left-4 text-5xl text-green-500 opacity-30">
                "
              </div>
              <p className="text-gray-300 mb-6 relative z-10">
                This platform completely changed how I approach coding. The
                daily challenges and mentor feedback helped me land my dream job
                at a tech startup.
              </p>
            ...
            <div className="card relative">
              <div className="absolute -top-4 -left-4 text-5xl text-blue-500 opacity-30">
                "
              </div>
              <p className="text-gray-300 mb-6 relative z-10">
                The hackathons were game-changing for me. I built my portfolio
                through these events and connected with amazing developers who
            ...
            <div className="card relative">
              <div className="absolute -top-4 -left-4 text-5xl text-purple-500 opacity-30">
                "
              </div>
              <p className="text-gray-300 mb-6 relative z-10">
                The community support is incredible. Whenever I got stuck, there
                was always someone ready to help. The mentorship program
                accelerated my learning by months.
              </p>
              <div className="flex items-center">
                <div className="w-12 h-12 rounded-full bg-gray-700 overflow-hidden mr-4">
                  <img
          ...
          <div className="max-w-4xl mx-auto bg-gray-900 rounded-xl p-8 border border-gray-700 shadow-2xl cta-content">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-300 max-w-2xl mx-auto">
                Join thousands of developers who are building their future with
                CodeNexus. Start your journey today!
              </p>
            </div>
